Review the code changes for issue #31: Summaries: app-specific tests
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #31"
...
After your review, write a JSON file to: review-issue-31.json
