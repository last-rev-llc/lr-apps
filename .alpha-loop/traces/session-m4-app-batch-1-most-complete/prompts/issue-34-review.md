Review the code changes for issue #34: Uptime: component migration
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #34"
...
After your review, write a JSON file to: review-issue-34.json
