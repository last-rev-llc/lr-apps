You just implemented GitHub issue #29: Standup: app-specific tests
...
## Review Summary
All acceptance criteria met: standup data rendering, Slack/GitHub aggregation, auth gate, and query tests all pass (163 tests across web + UI packages)
