Implement GitHub issue #38: Sprint Planning: component migration

## Summary
Replace inline UI patterns in Sprint Planning app with `@repo/ui` shared components.

## Acceptance Criteria
- [ ] Backlog cards use `@repo/ui` Card component
- [ ] Client grouping headers use shared components
- [ ] Archive display uses shared components
...
- Files changed: 3
- Duration: 560s
- PR: https://github.com/last-rev-llc/lr-apps/pull/138
...
3. Commit with: git commit -m "feat: Sprint Planning: component migration (closes #38)"