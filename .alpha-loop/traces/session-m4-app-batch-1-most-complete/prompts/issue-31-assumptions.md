You just implemented GitHub issue #31: Summaries: app-specific tests
...
## Review Summary
All 6 acceptance criteria met — 19 tests pass covering summary list rendering, Zoom/Slack/Jira-specific rendering, auth gate, and tab switching
