Review the code changes for issue #27: Accounts: app-specific tests
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #27"
...
After your review, write a JSON file to: review-issue-27.json
