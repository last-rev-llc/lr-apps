Implement GitHub issue #39: Sprint Planning: app-specific tests

## Summary
Add test coverage for Sprint Planning app — backlog grouping by client and archive display.

## Acceptance Criteria
- [ ] Test: backlog renders grouped by client with mock data
- [ ] Test: archive display shows completed sprints
- [ ] Test: ticket cards render with correct status
...
- Issue #38: Sprint Planning: component migration
- Status: failure
- Tests: FAILING
- Files changed: 0
- Duration: 55s
...
3. Commit with: git commit -m "feat: Sprint Planning: app-specific tests (closes #39)"