You just implemented GitHub issue #28: Standup: component migration
...
## Review Summary
Standup component migration complete — all inline cards, buttons, badges, and empty states replaced with @repo/ui shared components; build passes.
