Review the code changes for issue #33: Meeting Summaries: app-specific tests
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #33"
...
After your review, write a JSON file to: review-issue-33.json
