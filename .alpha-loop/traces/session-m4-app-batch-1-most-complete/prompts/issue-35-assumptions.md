You just implemented GitHub issue #35: Uptime: app-specific tests
...
## Review Summary
All acceptance criteria met: 17 uptime tests cover status badges, history charts, site list, auth gate, empty/error states. Full suite (181 tests) passes.
