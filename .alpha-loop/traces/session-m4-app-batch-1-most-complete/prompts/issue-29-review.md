Review the code changes for issue #29: Standup: app-specific tests
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #29"
...
After your review, write a JSON file to: review-issue-29.json
