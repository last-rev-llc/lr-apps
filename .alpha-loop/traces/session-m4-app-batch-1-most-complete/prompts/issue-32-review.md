Review the code changes for issue #32: Meeting Summaries: component migration
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #32"
...
After your review, write a JSON file to: review-issue-32.json
