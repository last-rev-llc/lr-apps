Review the code changes for issue #13: Auth gate: Alpha Wins
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #13"
...
After your review, write a JSON file to: review-issue-13.json
