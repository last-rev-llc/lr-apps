Review the code changes for issue #14: Auth gate: Brommie Quake
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #14"
...
After your review, write a JSON file to: review-issue-14.json
