Review the code changes for issue #7: Auth gate: Lighthouse
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #7"
...
After your review, write a JSON file to: review-issue-7.json
