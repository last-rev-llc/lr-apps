Review the code changes for issue #17: Auth gate: HSPT Practice
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #17"
...
After your review, write a JSON file to: review-issue-17.json
