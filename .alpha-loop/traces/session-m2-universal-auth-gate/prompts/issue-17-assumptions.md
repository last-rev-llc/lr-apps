You just implemented GitHub issue #17: Auth gate: HSPT Practice
...
## Review Summary
All acceptance criteria met: layout.tsx calls requireAppLayoutAccess, registry has auth: true, smoke tests cover unauth/unauthorized/happy paths, all tests pass.
