Review the code changes for issue #18: Auth gate: HSPT Tutor
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #18"
...
After your review, write a JSON file to: review-issue-18.json
