Review the code changes for issue #6: Auth gate: Area 52
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #6"
...
After your review, write a JSON file to: review-issue-6.json
