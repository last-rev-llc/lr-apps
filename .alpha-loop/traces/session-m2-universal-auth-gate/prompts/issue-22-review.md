Review the code changes for issue #22: Auth gate: Superstars
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #22"
...
After your review, write a JSON file to: review-issue-22.json
