Review the code changes for issue #12: Auth gate: Age of Apes
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #12"
...
After your review, write a JSON file to: review-issue-12.json
