You just implemented GitHub issue #12: Auth gate: Age of Apes
...
## Review Summary
All acceptance criteria met — layout calls requireAppLayoutAccess, registry has auth: true, smoke tests cover redirect scenarios, and pnpm test passes clean
