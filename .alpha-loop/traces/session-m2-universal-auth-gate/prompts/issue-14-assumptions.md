You just implemented GitHub issue #14: Auth gate: Brommie Quake
...
## Review Summary
All acceptance criteria met: layout.tsx calls requireAppLayoutAccess, registry has auth:true, smoke tests pass for all auth scenarios, pnpm test green.
