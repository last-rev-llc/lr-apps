You just implemented GitHub issue #21: Auth gate: Soccer Training
...
## Review Summary
All acceptance criteria met: layout calls requireAppLayoutAccess, registry has auth:true, smoke tests cover login/unauthorized redirects, all tests pass.
