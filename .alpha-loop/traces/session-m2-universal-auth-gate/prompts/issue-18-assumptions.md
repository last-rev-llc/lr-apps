You just implemented GitHub issue #18: Auth gate: HSPT Tutor
...
## Review Summary
All acceptance criteria met: layout calls requireAppLayoutAccess, registry has auth:true, smoke tests cover redirect scenarios, all 168 tests pass.
