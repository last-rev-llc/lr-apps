Review the code changes for issue #8: Update login/signup flows for universal auth
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #8"
...
After your review, write a JSON file to: review-issue-8.json
