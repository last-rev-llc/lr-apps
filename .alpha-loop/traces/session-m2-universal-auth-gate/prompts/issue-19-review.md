Review the code changes for issue #19: Auth gate: Proper Wine Pour
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #19"
...
After your review, write a JSON file to: review-issue-19.json
