Review the code changes for issue #21: Auth gate: Soccer Training
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #21"
...
After your review, write a JSON file to: review-issue-21.json
