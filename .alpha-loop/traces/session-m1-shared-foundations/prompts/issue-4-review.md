Review the code changes for issue #4: Expand  with typed query helpers
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #4"
...
After your review, write a JSON file to: review-issue-4.json
