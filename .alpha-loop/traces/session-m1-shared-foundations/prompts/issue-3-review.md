Review the code changes for issue #3: Add Vitest workspace config + shared test utilities
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #3"
...
After your review, write a JSON file to: review-issue-3.json
