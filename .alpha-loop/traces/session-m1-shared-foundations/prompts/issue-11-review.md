Review the code changes for issue #11: Extend app registry with billing metadata
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #11"
...
After your review, write a JSON file to: review-issue-11.json
