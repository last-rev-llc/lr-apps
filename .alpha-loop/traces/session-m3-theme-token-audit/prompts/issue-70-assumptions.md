You just implemented GitHub issue #70: Replace hardcoded tokens — batch 3 (showcase apps)
...
## Review Summary
All showcase apps successfully migrated to theme tokens. Fixed 2 remaining green-500/green-400 hardcoded classes in travel-collection.
