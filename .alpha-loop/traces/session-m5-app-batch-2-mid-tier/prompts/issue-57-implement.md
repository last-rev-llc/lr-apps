Implement GitHub issue #57: Roblox Dances: app-specific tests

## Summary
Add test coverage for Roblox Dances — dance listing and submission rendering.

## Acceptance Criteria
- [ ] Test: dance listing renders with mock data
- [ ] Test: submission form renders correctly
- [ ] Test: dance cards display video/image content
...
- Issue #56: Roblox Dances: component migration
- Status: failure
- Tests: FAILING
- Files changed: 0
- Duration: 23s
...
3. Commit with: git commit -m "feat: Roblox Dances: app-specific tests (closes #57)"