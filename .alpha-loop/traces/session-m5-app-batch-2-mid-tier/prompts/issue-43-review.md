Review the code changes for issue #43: Generations: app-specific tests
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #43"
...
After your review, write a JSON file to: review-issue-43.json
