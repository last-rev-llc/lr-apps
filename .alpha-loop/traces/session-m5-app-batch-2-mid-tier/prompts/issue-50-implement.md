Implement GitHub issue #50: Proper Wine Pour: component migration

## Summary
Replace inline UI in Proper Wine Pour with `@repo/ui` shared components.

## Acceptance Criteria
- [ ] Calculator UI uses `@repo/ui` Input, Card
- [ ] Restaurant cards use `@repo/ui` Card
- [ ] Community wall posts use shared components
...
- Issue #49: Daily Updates: app-specific tests
- Status: failure
- Tests: FAILING
- Files changed: 0
- Duration: 235s
...
3. Commit with: git commit -m "feat: Proper Wine Pour: component migration (closes #50)"