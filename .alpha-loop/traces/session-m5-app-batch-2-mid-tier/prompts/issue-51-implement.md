Implement GitHub issue #51: Proper Wine Pour: app-specific tests

## Summary
Add test coverage for Proper Wine Pour — pour calculation and community wall.

## Acceptance Criteria
- [ ] Test: pour calculation produces correct oz values
- [ ] Test: restaurant cards render with mock data
- [ ] Test: community wall posts display correctly
...
- Issue #50: Proper Wine Pour: component migration
- Status: failure
- Tests: FAILING
- Files changed: 0
- Duration: 33s
...
3. Commit with: git commit -m "feat: Proper Wine Pour: app-specific tests (closes #51)"