Review the code changes for issue #46: Cringe Rizzler: component migration
...
- CRITICAL (gaps, missing wiring, broken features): FIX THEM directly, run tests, commit with "fix: address review findings for #46"
...
After your review, write a JSON file to: review-issue-46.json
