Implement GitHub issue #54: HSPT Tutor: component migration

## Summary
Replace inline UI in HSPT Tutor with `@repo/ui` shared components.

## Acceptance Criteria
- [ ] Question display uses `@repo/ui` Card
- [ ] Answer selection uses shared components
- [ ] Progress indicators use shared components
...
- Issue #53: HSPT Practice: app-specific tests
- Status: failure
- Tests: FAILING
- Files changed: 0
- Duration: 27s
...
3. Commit with: git commit -m "feat: HSPT Tutor: component migration (closes #54)"