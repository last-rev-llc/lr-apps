Implement GitHub issue #55: HSPT Tutor: app-specific tests

## Summary
Add test coverage for HSPT Tutor — adaptive question selection and weak-spot prioritization.

## Acceptance Criteria
- [ ] Test: adaptive question selection picks appropriate difficulty
- [ ] Test: weak-spot prioritization identifies correct areas
- [ ] Test: question display renders correctly
...
- Issue #54: HSPT Tutor: component migration
- Status: failure
- Tests: FAILING
- Files changed: 0
- Duration: 25s
...
3. Commit with: git commit -m "feat: HSPT Tutor: app-specific tests (closes #55)"