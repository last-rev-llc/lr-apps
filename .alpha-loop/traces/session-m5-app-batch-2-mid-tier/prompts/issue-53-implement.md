Implement GitHub issue #53: HSPT Practice: app-specific tests

## Summary
Add test coverage for HSPT Practice — section selection, timed exam flow, scoring.

## Acceptance Criteria
- [ ] Test: section selection renders all sections
- [ ] Test: timed exam flow starts and counts down
- [ ] Test: scoring calculates correct results
- [ ] Test: question cards render with answer choices
...
- Issue #52: HSPT Practice: component migration
- Status: failure
- Tests: FAILING
- Files changed: 0
- Duration: 27s
...
3. Commit with: git commit -m "feat: HSPT Practice: app-specific tests (closes #53)"