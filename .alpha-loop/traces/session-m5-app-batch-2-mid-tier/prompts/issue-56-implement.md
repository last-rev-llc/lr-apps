Implement GitHub issue #56: Roblox Dances: component migration

## Summary
Replace inline UI in Roblox Dances with `@repo/ui` shared components.

## Acceptance Criteria
- [ ] Dance cards use `@repo/ui` Card
- [ ] Submission UI uses shared Input, Button components
...
3. Commit with: git commit -m "feat: Roblox Dances: component migration (closes #56)"