...
| Meeting Summaries | [#517](https://github.com/last-rev-llc/lr-apps/issues/517) | error (zoom_transcripts table missing — no migration exists in repo) | [#648](https://github.com/last-rev-llc/lr-apps/issues/648) | [PR #383 comment](https://github.com/last-rev-llc/lr-apps/pull/383#issuecomment-4357101750) |
| Sales | [#523](https://github.com/last-rev-llc/lr-apps/issues/523) | stalled (dev-only; leads is dual-writer with AI Calculator — source-breakdown SELECT deferred to backlog; createdAt-null on all 45 rows flagged as separate data-quality bug) | [#651](https://github.com/last-rev-llc/lr-apps/issues/651) | [PR #384 comment](https://github.com/last-rev-llc/lr-apps/pull/384#issuecomment-4357144730) |
| Lighthouse | [#530](https://github.com/last-rev-llc/lr-apps/issues/530) | stalled (dev-only; lighthouse_audits writer is external — no Vercel Cron in apps/web/vercel.json targets it, migration header confirms prod provisioned outside repo; createdAt null + text-typed flagged separately) | [#652](https://github.com/last-rev-llc/lr-apps/issues/652) | [PR #404 comment](https://github.com/last-rev-llc/lr-apps/pull/404#issuecomment-4357149904) |
