...
class CcCalendar extends HTMLElement {
  ...
  _renderEvents(events) {
    ...
    return events.map(e => {
      ...
      const zoom = e.isZoom && e.zoomLink ? ` · <a href="${e.zoomLink}" target="_blank" class="zoom-link">📹 Zoom</a>` : '';
      ...
      return `${divider}<li class="event-item">
        ...
        <div class="event-details">
          <div class="event-name"><a href="${e.htmlLink}" target="_blank">${e.summary || 'No title'}</a></div>
