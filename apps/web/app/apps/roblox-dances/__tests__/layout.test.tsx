...
describe("RobloxDancesLayout", () => {
  it("calls requireAppLayoutAccess with 'roblox-dances'", async () => {
    mockRequireAppLayoutAccess.mockResolvedValueOnce(undefined);
    await callLayout();
    expect(mockRequireAppLayoutAccess).toHaveBeenCalledWith("roblox-dances");
  });
