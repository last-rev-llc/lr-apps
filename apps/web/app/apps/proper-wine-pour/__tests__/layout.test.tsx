...
describe("ProperWinePourLayout", () => {
  it("calls requireAppLayoutAccess with 'proper-wine-pour'", async () => {
    mockRequireAppLayoutAccess.mockResolvedValueOnce(undefined);
    await callLayout();
    expect(mockRequireAppLayoutAccess).toHaveBeenCalledWith("proper-wine-pour");
  });
