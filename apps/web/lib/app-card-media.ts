...
const APP_CARD_ALT: Record<string, string> = {
  "accounts": "Floating glass dashboard panels on dark navy background with amber grid accents",
  ...
  "crm": "Floating customer profile cards in violet and amber over emerald hexagonal grid on dark slate",
  ...
  "ideas": "Constellation of glowing filament lightbulbs with amber and emerald sparks on dark midnight background",
  ...
  "meme-generator": "Three blank meme template panels with Top Text Bottom Text on chaotic comic-halftone burst background",
