...
(function () {
  ...
  STYLE.textContent = `
    ...
    /* Mobile: bottom panel instead of left sidebar */
    ...
    @media (max-width: 500px) {
      .cc-edit-sidebar {
        ...
        border-right: none; border-top: 1px solid var(--border, #333);
        transform: translateY(100%);
        box-shadow: 0 -8px 32px rgba(0,0,0,.6);
      }
      .cc-edit-sidebar.open { transform: translateY(0); }
    }
    ...
    /* Mobile: hide tip and URL to save vertical space */
    @media (max-width: 500px) {
      .cc-edit-url,
      .cc-edit-no-component-hint {
        display: none;
      }
      .cc-edit-sidebar-body { padding: 12px; }
      .cc-edit-no-focus { padding: 20px 12px; }
    }
  `;
  ...
  class CcEditMode {
    ...
    _tagComponents() {
      document.querySelectorAll('*').forEach(el => {
        ...
        const noTag = ['cc-fade-in', 'cc-blog']; // too generic — children get tagged instead
